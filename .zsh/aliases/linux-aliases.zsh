...
if $USE_COLORLS; then
    alias l='command colorls -l --color=auto'
    alias l.='command colorls -d .* --color=auto'
    alias la='command colorls -la --color=auto'
    alias lad='command colorls -d .*(/)'
    alias lh='command colorls -hAl --color=auto'
    alias ll='command colorls -l --color=auto'
    alias ls='command colorls --color=auto'
